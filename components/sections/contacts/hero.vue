        ...
        <div class="contacts-hero__main">
          <div class="contacts-hero__row">
            <div class="contacts-hero__info">
              <div class="contacts-hero__image">
                <img src="/img/contacts/hero.jpg" alt="" />
              </div>
              <div class="contacts-hero__block">
                ...
                <div>
                  <p class="h4">
                    {{ city }},
                    <br />
                    <span style="translate: -5px 0; display: block">{{ address }}</span>
                  </p>
              ...
              <p
                ...
                "
              >
                ИП Нетуков Георгий Валерьевич, ИНН 780446753604, ОГРНИП 322784700148399, г. Москва, ул. Нащокинский
                переулок, д. 8
              </p>
            </div>
          ...
          <ul class="contacts-hero__list">
            <li class="contacts-hero__item" v-for="(item, index) in info?.contacts_hero_list" :key="item">
              ...
              <h3 class="h3" :class="{ 'light-title': index == 0, 'dark-title': index !== 0 }">{{ item?.title }}</h3>
