<template>
  <section class="buy-ways">
    ...
    <div class="container">
      <BannersIpoteka @form="onForm" v-if="commerce" />

      <div class="buy-ways__wrapper" v-else>
        <h2 class="buy-ways__title h1 dark-title">
          способы
          <span>покупки</span>
        </h2>
            ...
            <div class="buy-ways__content" v-if="tab == 0">
              ...
              <div class="buy-ways__items">
                <div class="buy-ways__cats">
                  ...
                  <span>
                    {{ items.length }} {{ morph(items.length, ['предложение', 'предложения', 'предложений']) }}
                  </span>
                </div>
