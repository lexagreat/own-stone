   ...
   <UiModal :isOpen="isOpen" @closePopup="emit('closePopup')" class="object-form">
      ...
      <div class="modal__content object-form__content" ref="wrapper" v-else>
         ...
         <div class="object-form__header">
            ...
            <p class="body-text" v-if="tab == 0">Подберём выгодную банковскую программу и поможем с одобрением ипотеки
            </p>
            <p class="body-text" v-else>Поможем сделать правильный выбор <br> без переплат</p>
         </div>
