   ...
   <UiModal :isOpen="isOpen" @closePopup="emit('closePopup')" class="object-form">
      ...
      <div class="modal__content object-form__content" v-else>
         ...
         <div class="object-form__header">
            <h3 class="object-form__title h1 dark-title">Запланировать <span>визит</span>
            </h3>
            <p class="body-text">Если вы хотите назначить встречу с персональным брокером - оставьте заявку и мы
               подберем удобную дату и время!</p>
         </div>
