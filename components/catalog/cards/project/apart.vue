    ...
    <div class="catalog-card__main">
      <div class="catalog-card__content">
        <ul class="catalog-card__banners">
          <li v-if="product?.count_rooms > 0">
            {{ product?.count_rooms }} {{ morph(+product?.count_rooms, ['комната', 'комнаты', 'комнат']) }}
          </li>
          <li v-else>студия</li>
          ...
          <li>
            этаж {{ product?.floor }}
            <span v-if="product?.proekty?.floors_count">/{{ product?.proekty?.floors_count }}</span>
          </li>
          <!-- <li>ID {{ product?.id }}</li> -->
        </ul>
