      ...
      <section class="document-page">
         <div class="container">
            <div class="document-page__wrapper">
               <h1 class="h1">Политика в отношении обработки персональных данных</h1>
               <ul class="document-page__list">
                  <li class="document-page__section">
                     <h2 class="document-page__title">1. Общие положения</h2>
                     <p> Настоящая политика обработки персональных данных составлена в соответствии с требованиями
                        ...
                        предпринимаемые Индивидуальным предпринимателем Нетуковым Георгием Валерьевичем, ИНН
                        780446753604, ОГРНИП
                        322784700148399, г. Москва, Нащокинский пер, д. 8. (далее – Оператор).</p>
                     <ul class="document-page__sublist">
                        ...
                        <li> 1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее –
                           ...
                           https://ownstone.ru.</li>
                     </ul>
                  </li>
                  <li class="document-page__section">
                     <h2 class="document-page__title">2. Основные понятия, используемые в Политике</h2>
                     ...
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           ЭВМ и
                           баз
                           данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://ownstone.ru.
                        </li>
                        <li>
                        ...
                        <li>
                           ...
                           или
                           определяемому Пользователю веб-сайта https://ownstone.ru.
                        </li>
                        <li>
                        ...
                        <li>2.10. Пользователь – любой посетитель веб-сайта https://ownstone.ru.</li>
                        <li>
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 3. Основные права и обязанности Оператора</h2>
                     <ul class="document-page__sublist">
                        <li>
                        ...
                        <li>
                           ...
                           органа
                           необходимую информацию в течение 30 дней с даты получения такого запроса; – публиковать или
                           иным
                           образом
                           ...
                           персональных
                           данных; – прекратить передачу (распространение, предоставление, доступ) персональных данных,
                           прекратить
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 4. Основные права и обязанности субъектов персональных данных
                     </h2>
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           порядок ее
                           получения установлен Законом о персональных данных; – требовать от оператора уточнения его
                           персональных
                           ...
                           цели
                           обработки,
                           а также принимать предусмотренные законом меры по защите своих прав; – выдвигать условие
                           предварительного
                           согласия при обработке персональных данных в целях продвижения на рынке товаров, работ и
                           услуг; – на
                           отзыв согласия на обработку персональных данных; – обжаловать в уполномоченный орган по
                           защите прав
                           субъектов персональных данных или в судебном порядке неправомерные действия или бездействие
                           Оператора
                           при
                           обработке его персональных данных; – на осуществление иных прав, предусмотренных
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 5. Оператор может обрабатывать следующие персональные данные
                        Пользователя
                     </h2>
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           файлов
                           «cookie») с помощью сервисов интернет-статистики (Яндекс Метрика и других).
                        </li>
                        ...
                        <li>
                           ...
                           свое
                           действие с момента поступления Оператору требования, указанного в п. 5.8.3 настоящей Политики
                           в
                           отношении
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 6. Принципы обработки персональных данных
                     </h2>
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           определенных и
                           законных
                           целей. Не допускается обработка персональных данных, несовместимая с целями сбора
                           персональных данных.
                        </li>
                        <li>
                        ...
                        <li>
                           ...
                           обработки.
                           Не
                           допускается избыточность обрабатываемых персональных данных по отношению к заявленным целям
                           их
                           обработки.
                        </li>
                        <li>
                        ...
                        <li>
                           ...
                           персональных
                           данных не установлен федеральным законом, договором, стороной которого, выгодоприобретателем
                           или
                           поручителем по которому является субъект персональных данных. Обрабатываемые персональные
                           данные
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 7. Цели обработки персональных данных
                     </h2>
                     <ul class="document-page__sublist">
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title">8. Правовые основания обработки персональных данных
                     </h2>
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           - договоры, заключенные между Оператором и Пользователем;
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 9. Условия обработки персональных данных
                     </h2>
                     <ul class="document-page__sublist">
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 10. Порядок сбора, хранения, передачи и других видов обработки
                        персональных данных Безопасность
                     ...
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           info@ownstone.ru с пометкой «Актуализация персональных данных».
                        </li>
                        <li>
                           10.4. Срок обработки персональных данных определяется достижением целей, для которых были
                           собраны
                           персональные данные но не более 5 лет, если иной срок не предусмотрен договором или
                           действующим
                           ...
                           Оператора
                           info@ownstone.ru с пометкой «Отзыв согласия на обработку персональных данных».
                        </li>
                        <li>
                           ...
                           персональных
                           данных и/или Пользователь обязан самостоятельно своевременно ознакомиться с указанными
                           документами.
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 11. Перечень действий, производимых Оператором с полученными
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 12. Трансграничная передача персональных данных
                     </h2>
                     <ul class="document-page__sublist">
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 13. Конфиденциальность персональных данных
                     </h2>
                     <p>
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 14. Заключительные положения
                     </h2>
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           обработки его
                           персональных данных, обратившись к Оператору с помощью электронной почты info@ownstone.ru
                        </li>
                        <li>
