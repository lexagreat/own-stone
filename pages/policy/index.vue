               ...
               <ul class="document-page__list">
                  <li class="document-page__section">
                     ...
                     <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями
                        ...
                        персональных данных, предпринимаемые Антоненко Сергей Михайлович (далее – Оператор).</p>
                     <ul class="document-page__sublist">
                        <li>1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности
                           ...
                           числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.</li>
                        <li>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее –
                           ...
                           веб-сайта https://ownstone.ru.</li>
                     </ul>
                  </li>
                  <li class="document-page__section">
                     ...
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           результате которых невозможно определить без использования дополнительной информации
                        ...
                        <li>
                           ...
                           косвенно к определенному или определяемому Пользователю веб-сайта https://ownstone.ru.
                        </li>
                        <li>
                           2.9.
                        ...
                        <li>
                           2.10. Пользователь – любой
                           посетитель веб-сайта https://ownstone.ru.
                        </li>
                        <li>
                  ...
                  <li class="document-page__section">
                     ...
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           соответствии с
                           ним нормативными правовыми актами, если иное не предусмотрено Законом о персональных данных
                           или
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title">4. Основные права и обязанности субъектов персональных данных</h2>
                     <ul class="document-page__sublist">
                        <li>
                  ...
                  <li class="document-page__section">
                     ...
                     <ul class="document-page__sublist">
                        ...
                        <li>
                           ...
                           персональных данных, а также перечень персональных данных, обработка которых подлежит
                           прекращению.
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title">6. Принципы обработки персональных данных</h2>
                     <ul class="document-page__sublist">
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title">8. Правовые основания обработки персональных данных</h2>
                     <ul class="document-page__sublist">
                        <li>
                           8.1. Правовыми основаниями обработки персональных данных Оператором являются:
                           – перечислите нормативно-правовые акты, регулирующие отношения, связанные с вашей
                           деятельностью,
                           например, если ваша деятельность связана с информационными технологиями, в частности с
                           созданием
                           сайтов, то здесь можно указать Федеральный закон "Об информации, информационных технологиях и
                           о
                           защите
                        ...
                        <li>
                           ...
                           https://ownstone.ru или направленные Оператору посредством электронной почты. Заполняя
                           соответствующие
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title"> 9. Условия обработки персональных данных</h2>
                     <ul class="document-page__sublist">
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title">10. Порядок сбора, хранения, передачи и других видов обработки
                        ...
                        требований
                        действующего законодательства в области защиты персональных данных.</h2>
                     <ul class="document-page__sublist">
                        <li>
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title">12. Трансграничная передача персональных данных</h2>
                     <ul class="document-page__sublist">
                        <li>
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title">13. Конфиденциальность персональных данных</h2>
                     <ul class="document-page__sublist">
                        <li>
                  ...
                  <li class="document-page__section">
                     <h2 class="document-page__title">14. Заключительные положения</h2>
                     <ul class="document-page__sublist">
                        <li>
