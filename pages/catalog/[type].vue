        ...
        <div class="catalog-page__wrapper">
          <div class="catalog-page__header">
            ...
            <div class="catalog-page__controls">
              ...
              <UiButton
                class="catalog-page__map white"
                :class="{ active: catalog.isMap }"
          ...
          >
            ...
            <CatalogListsColumn
              :products="splicedProducts[0]"
              @openForm="onOpenForm"
              v-if="currentView == 'column'"
              :category="category"
            />
            <BannersCatalogObject />
            <CatalogListsGrid
              :products="splicedProducts[1]"
              @openForm="onOpenForm"
              v-if="currentView == 'grid' && splicedProducts[1].length"
              :category="category"
            />
            <CatalogListsColumn
              :products="splicedProducts[1]"
              @openForm="onOpenForm"
              v-if="currentView == 'column' && splicedProducts[1].length"
              :category="category"
            />
          </div>
          <CatalogMap
